                    ...
                    <tr>
                        ...
                        <td>
                            <div class="btn-group" role="group" aria-label="Basic example">
                                <a href="{{ route('posts.edit', $post->id) }}" type="button" class="btn btn-primary"><i
                                        class="fa fa-edit"></i></a>

                                <a href="{{ route('posts.show', $post->id) }}" type="button" class="btn btn-info"><i
                                        class="fa fa-eye"></i></a>
                                ...
                                <div class="modal fade" id="delete_post_{{ $post->id }}" tabindex="-1" role="dialog"
                                    aria-labelledby="exampleModalLabel" aria-hidden="true">
                                    <div class="modal-dialog" role="document">
                                        <form action="{{ route('posts.destroy', $post->id) }}"
                                            id="form_delete_post_{{ $post->id }}" method="post">
                                            @csrf
                                            @method('DELETE');
